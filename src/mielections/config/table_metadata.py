...
TABLE_DEFINITIONS: dict[str, TableDefinition] = {
    ...
    "jurisdictions": TableDefinition(
        ...
        columns=(
            ...
            CsvColumnDefinition("jurisdiction_name", "jurisdiction_name", "string", True, "Jurisdiction name."),
            CsvColumnDefinition("clerk_name", "clerk_name", "string", False, "Clerk contact name."),
            CsvColumnDefinition("clerk_email", "clerk_email", "string", False, "Clerk email address."),
            CsvColumnDefinition("jurisdiction_type", "jurisdiction_type", "string", False, "Type such as City or Township."),
        ),
        upsert_columns=("county_id", "jurisdiction_name"),
        preview_columns=("county_name", "jurisdiction_name", "clerk_name", "clerk_email", "jurisdiction_type"),
    ),
    "locations": TableDefinition(
        ...
        columns=(
            CsvColumnDefinition("county_name", "county_name", "string", True, "Existing county name."),
            CsvColumnDefinition("jurisdiction_name", "jurisdiction_name", "string", True, "Existing jurisdiction name."),
        ...
        upsert_columns=("jurisdiction_id", "location_name", "address"),
        preview_columns=("county_name", "jurisdiction_name", "location_name", "address", "city", "zip_code"),
    ),
    ...
    "election_usage": TableDefinition(
        ...
        columns=(
            ...
            CsvColumnDefinition("open_date", "open_date", "date", False, "Opening date."),
            CsvColumnDefinition("close_date", "close_date", "date", False, "Closing date."),
            CsvColumnDefinition("hours", "hours", "string", False, "Hours of operation."),
            CsvColumnDefinition("notes", "notes", "string", False, "Optional notes."),
        ),
        upsert_columns=("election_id", "location_id", "location_function"),
        preview_columns=("location_name", "address", "election_type", "election_date", "location_function", "open_date", "close_date"),
    ),
}
